...
namespace Swag.Plugin.Swagger.Models
{
    ...
    /// </summary>
    public class SwagOptions(SwaggerGenOptions options)
    {
        ...
        /// </summary>
        public void EnableAcceptedLanguage() { options.OperationFilter<AcceptLanguageHeaderOperationFilter>(); }
        ...
        /// </summary>
        public void CamelCaseParameters() { options.OperationFilter<CamelCaseParametersOperationFilter>(); }
        ...
        /// </remarks>
        public void EnableAutoSwaggerDocumentation() { options.OperationFilter<SwagCrudOperationFilter>(); }
    }
}
